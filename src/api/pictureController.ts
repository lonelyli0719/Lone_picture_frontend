...
/** editPictureByBatchThreadPool POST /api/picture/edit/batch/threadPool */
export async function editPictureByBatchThreadPoolUsingPost(
  body: API.PictureEditByBatchRequest,
  options?: { [key: string]: any }
) {
  return request<API.BaseResponseBoolean_>('/api/picture/edit/batch/threadPool', {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
    },
